...
namespace Drupal\brand_strip\Plugin\Block;

use Drupal\Core\Block\BlockBase;
use Drupal\Core\Form\FormStateInterface;

/**
 * Provides a 'Brand_strip' Block.
 *
 * @Block(
 *   id = "brand_strip_block",
 *   admin_label = @Translation("Brand_strip Block"),
 *   category = @Translation("Customs")
 * )
 */
class Brand_stripBlock extends BlockBase
{
  /**
   * {@inheritdoc}
   */
  ...
  {
    $itemKey = "strips"; //fieldset item key
  ...
  public function blockSubmit($form, FormStateInterface $form_state)
  {
    ...
    //dump($this->configuration["strips"]);
  ...
  public function build()
  {
    ...
    $ret =  [
      ...
      '#attached' => [
        'library' => [
          'brand_strip/brand_strip-styles',
        ],
      ],
    ];
