<?php
namespace Drupal\basicpagenav\Plugin\Block;

use Drupal\Core\Block\BlockBase;
use Drupal\Core\Form\FormStateInterface;
/**
 * Provides a 'Basicpagenav' Block.
 *
 * @Block(
 *   id = "basicpagenav_block",
 *   admin_label = @Translation("Basicpagenav Block"),
 * )
 */
class BasicpagenavBlock extends BlockBase {
  /**
   * {@inheritdoc}
   */
  ...
  public function build()
  {
    ...
    $ret =  [
      ...
      '#attached' => [
        'library' => [
          'basicpagenav/basicpagenav-styles',
        ],
      ],
    ];
    foreach($data as $k=>$v){
